<template>
  <div class="sidebar-box">
    <div class="lay-sidebar" :style="{ height: Side.screenH }">
      <div class="card">
        ...
        <div class="card-content">
          <img
            src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fp2.itc.cn%2Fq_70%2Fimages03%2F20211120%2Fb8f247c29b31430483497fb7d626b857.jpeg&refer=http%3A%2F%2Fp2.itc.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1658551128&t=5ab37fe3678b7d76831c67a014308394s"
            class="avatar"
          />
          <div class="username">litchi</div>
...
const Side = reactive<sideType>({
  screenH: "0",
});
onBeforeMount(() => {
  const height = `${document.documentElement.clientHeight}`;
  Side.screenH = height + "px";
});
</script>
